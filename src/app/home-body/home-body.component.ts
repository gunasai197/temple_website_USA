...
export class HomeBodyComponent implements OnInit {
  images: string[] = ['/assets/Event_Images/sliding_img_1.gif', '/assets/Event_Images/sliding_img_2.jpg','/assets/Event_Images/sliding_img_3.jpg','/assets/Event_Images/sliding_img_4.jpg','/assets/Event_Images/sliding_img_5.jpg','/assets/Event_Images/sliding_img_6.jpg'];
